...
// let scale_max = document.querySelector(".score_max")
// let scale_min = document.querySelector(".score_minus")
// function score() {
  
// }

Barch_Snake.start(8);
Barch_Snake.setup.keyboard(true);
Barch_Snake.setup.fixedTail(false);
